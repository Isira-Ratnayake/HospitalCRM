...
namespace HospitalCRM.View
{
    public partial class CheckUpList : Form
    {
        ...
        public CheckUpList(CrmEngine crmEngine, Stack<Form> formStack)
        {
            InitializeComponent();
        ...
        private void CheckUpList_Load(object sender, EventArgs e)
        {
            string lo_name = crmEngine.GetLoggedInUser().GetUserName();
            bunifuLabel10.Text = lo_name;

            DataTable dataTable = new DataTable();
            crmEngine.GetCheckUpData(dataTable);
        ...
        private void bunifuButton24_Click(object sender, EventArgs e)
        {
            ...
            ErrorMessage errorMessage = crmEngine.GetCheckUpPatient(patient);
            switch (errorMessage)
            {
                ...
                case ErrorMessage.OK:
                    ...
                    this.Visible = false;
                    formStack.Push(this);
                    new AddCheckUpForm(crmEngine, formStack, patient).Show();
                    break;
            }
        }

        public void RefreshCheckUpList() { 
